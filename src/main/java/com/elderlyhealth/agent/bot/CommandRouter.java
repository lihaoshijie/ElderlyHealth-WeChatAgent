...
import com.elderlyhealth.agent.bot.skill.Skill;
import com.elderlyhealth.agent.bot.skill.SkillManager;
import com.elderlyhealth.agent.bot.cli.Command;
import com.elderlyhealth.agent.entity.Task;
import com.elderlyhealth.agent.exception.BusinessException;
import com.elderlyhealth.agent.service.*;
...
public class CommandRouter {
    ...
    private void forcePatchMissingCalls(String reply, String userInput, String userId) {
        ...
        if (userInput.contains("发短信") || userInput.contains("短信") || userInput.contains("sms")) {
            ...
            String body = userInput.contains("祝福") ? "祝你生活愉快，万事如意！" : "来自银龄智护的消息";
